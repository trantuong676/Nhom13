...
namespace TuongVuongCoffee.Controllers
{
    public class HoaDonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HoaDonID,HoaDonName,SoLuong")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("HoaDonID,HoaDonName,SoLuong")] HoaDon hoaDon)
        {
